...
Begin VB.Form frmWiz01 
   ...
   Begin VB.PictureBox picFrames 
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   1
         ItemData        =   "frmWiz01.frx":1D46
         Left            =   2520
         List            =   "frmWiz01.frx":1D48
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   29
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   8
         ItemData        =   "frmWiz01.frx":1D4A
         Left            =   2520
         List            =   "frmWiz01.frx":1D4C
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   57
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   7
         ItemData        =   "frmWiz01.frx":1D4E
         Left            =   2520
         List            =   "frmWiz01.frx":1D50
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   53
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   6
         ItemData        =   "frmWiz01.frx":1D52
         Left            =   2520
         List            =   "frmWiz01.frx":1D54
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   49
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   5
         ItemData        =   "frmWiz01.frx":1D56
         Left            =   2520
         List            =   "frmWiz01.frx":1D58
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   45
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   4
         ItemData        =   "frmWiz01.frx":1D5A
         Left            =   2520
         List            =   "frmWiz01.frx":1D5C
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   41
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   3
         ItemData        =   "frmWiz01.frx":1D5E
         Left            =   2520
         List            =   "frmWiz01.frx":1D60
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   37
         Tag             =   "TabStop"
...
Private Sub Form_Load()
    ...
    Call Wiz01PopulateHonors(lstHonors)
...
Private Sub lblStats_Click()
    Call picTabs_Click(1)
End Sub
Private Sub lstHonors_GotFocus()
    TextSelected
    lstHonors.ListIndex = 0
End Sub
Private Sub lstHonors_LostFocus()
    lstHonors.ListIndex = -1
End Sub
...
Private Sub LoadCharacter(iCharacter As Integer)
    ...
    With Characters(iCharacter)
        ...
        Call Wiz01SetHonors(lstHonors, .Honors)
...
Private Sub UnloadCharacter(iCharacter As Integer)
    ...
    With Characters(iCharacter)
        ...
        .Honors = Wiz01GetHonors(lstHonors)
