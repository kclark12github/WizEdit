...
Begin VB.Form frmWiz01 
   ...
   Begin VB.PictureBox picFrames 
      ...
      Begin VB.ComboBox cboRace 
         ...
         ForeColor       =   &H0000FFFF&
         Height          =   336
         ItemData        =   "frmWiz01.frx":1CDC
         Left            =   4980
         List            =   "frmWiz01.frx":1CE3
         Style           =   2  'Dropdown List
         TabIndex        =   7
      ...
      Begin VB.ComboBox cboGender 
         ...
         ForeColor       =   &H0000FFFF&
         Height          =   336
         ItemData        =   "frmWiz01.frx":1CFD
         Left            =   4980
         List            =   "frmWiz01.frx":1D07
         Locked          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Tag             =   "TabStop"
   ...
   Begin VB.PictureBox picFrames 
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   1
         ItemData        =   "frmWiz01.frx":1D1C
         Left            =   2520
         List            =   "frmWiz01.frx":1D1E
         Style           =   2  'Dropdown List
         TabIndex        =   25
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   8
         ItemData        =   "frmWiz01.frx":1D20
         Left            =   2520
         List            =   "frmWiz01.frx":1D22
         Style           =   2  'Dropdown List
         TabIndex        =   53
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   7
         ItemData        =   "frmWiz01.frx":1D24
         Left            =   2520
         List            =   "frmWiz01.frx":1D26
         Style           =   2  'Dropdown List
         TabIndex        =   49
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   6
         ItemData        =   "frmWiz01.frx":1D28
         Left            =   2520
         List            =   "frmWiz01.frx":1D2A
         Style           =   2  'Dropdown List
         TabIndex        =   45
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   5
         ItemData        =   "frmWiz01.frx":1D2C
         Left            =   2520
         List            =   "frmWiz01.frx":1D2E
         Style           =   2  'Dropdown List
         TabIndex        =   41
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   4
         ItemData        =   "frmWiz01.frx":1D30
         Left            =   2520
         List            =   "frmWiz01.frx":1D32
         Style           =   2  'Dropdown List
         TabIndex        =   37
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   3
         ItemData        =   "frmWiz01.frx":1D34
         Left            =   2520
         List            =   "frmWiz01.frx":1D36
         Style           =   2  'Dropdown List
         TabIndex        =   33
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   2
         ItemData        =   "frmWiz01.frx":1D38
         Left            =   2520
         List            =   "frmWiz01.frx":1D3A
         Style           =   2  'Dropdown List
         TabIndex        =   29
         Tag             =   "TabStop"
...
Private Sub LoadCharacter(iCharacter As Integer)
    ...
    With Characters(iCharacter)
        ...
        txtEXP.Text = Format(cvtTP6ToDouble(.EXP), "#,##0")
        txtGP.Text = Format(cvtTP6ToDouble(.GP), "#,##0")
...
Private Sub UnloadCharacter(iCharacter As Integer)
    ...
    With Characters(iCharacter)
        ...
        Call cvtDoubleToTP6(CDbl(txtEXP.Text), .EXP)
        Call cvtDoubleToTP6(CDbl(txtGP.Text), .GP)
