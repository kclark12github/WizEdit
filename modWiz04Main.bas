Attribute VB_Name = "modWiz04Main"
'modWiz04Main - modWiz04Main.bas
'   Main module for The Return of Werdna...
...
Global Const Wiz04ScenarioName As String = "THE RETURN OF WERDNA"
Global Const Wiz04ScenarioDataOffset As Long = &H4BC01
Global Const Wiz04CharacterDataOffset As Long = &H4AC01
Global Const Wiz04CharactersMax As Integer = 8
Global Const Wiz04ItemListMax As Integer = 8
Global Const Wiz04ItemMapMin As Integer = 1000
Global Const Wiz04ItemMapMax As Integer = 1103
Global Const Wiz04AlignmentMapMax As Integer = 3
Global Const Wiz04RaceMapMax As Integer = 5
Global Const Wiz04ProfessionMapMax As Integer = 7
Global Const Wiz04StatusMapMax As Integer = 7
Global Const Wiz04SpellLevelMax As Integer = 7
Global Const Wiz04SpellMapMax As Integer = 50

Type Wiz04ScenarioTag
    Length As Byte
    Name As String * 48
End Type
...
Type Wiz04Character
    ...
    ItemList(1 To 8) As Wiz04Item       '0x1D83C    List of Items (stowing not an option in Wiz04...)
    EXP(1 To 3) As Integer              '0x1D87C
    LVL As Wiz04Points                  '0x1D882
    HP As Wiz04Points                   '0x1D886
...
End Type
Private ItemList(Wiz04ItemMapMin To Wiz04ItemMapMax) As String
Private Spells(0 To Wiz04SpellMapMax) As String
...
Private Function strRace(ByVal x As Byte) As String
    ...
    End Select
End Function
Private Function strItem(x As Wiz04Item) As String
...
End Function
Private Function strPoints(x As Wiz04Points) As String
...
End Function
Private Function Wiz04Dumapic(xCharacter As Wiz04Character) As String
    With xCharacter
        ' Always seems to be facing North when Quiting from within the Maze...
        Wiz04Dumapic = "Facing North; " & (.Location \ 100) & " East; " & (.Location Mod 100) & " North; " & .Down & " Down"  ' from the steps leading to the castle"
    End With
End Function
Public Sub Wiz04DumpCharacter(xCharacter As Wiz04Character)
    Dim i As Long
    Dim j As Long
    Dim k As Long
    Dim iChar As Long
    ...
    With xCharacter
        ...
        End If
        Debug.Print Wiz04Dumapic(xCharacter)
        ...
        Debug.Print "Strength:           " & vbTab & Wiz04cvtStatisticToInt(.Statistics, 1)
        Debug.Print "Intellegence:       " & vbTab & Wiz04cvtStatisticToInt(.Statistics, 2)
        Debug.Print "Piety:              " & vbTab & Wiz04cvtStatisticToInt(.Statistics, 3)
        Debug.Print "Vitality:           " & vbTab & Wiz04cvtStatisticToInt(.Statistics, 4)
        Debug.Print "Agility:            " & vbTab & Wiz04cvtStatisticToInt(.Statistics, 5)
        Debug.Print "Luck:               " & vbTab & Wiz04cvtStatisticToInt(.Statistics, 6)
...
ErrorHandler:
    MsgBox Err.Description, vbExclamation, "Wiz04DumpCharacter"
    Exit Sub
    Resume Next
End Sub
Public Sub Wiz04cvtBstrToSpells(bString As String, Data() As Byte)
    Dim i As Long
...
ErrorHandler:
    MsgBox Err.Description, vbExclamation, "Wiz04cvtSpellsToBstr"
    Exit Sub
    Resume Next
End Sub
Public Function Wiz04cvtSpellsToBstr(Data() As Byte) As String
    Dim i As Long
...
ErrorHandler:
    ...
    Resume Next
End Function
Public Function Wiz04cvtStatisticsToLong(Stat1 As String, Stat2 As String, Stat3 As String, Stat4 As String, Stat5 As String, Stat6 As String) As Long
    Wiz04cvtStatisticsToLong = (CLng(Stat1) * (2 ^ 0)) + (CLng(Stat2) * (2 ^ 5)) + (CLng(Stat3) * (2 ^ 10)) + (CLng(Stat4) * (2 ^ 16)) + (CLng(Stat5) * (2 ^ 21)) + (CLng(Stat6) * (2 ^ 26))
End Function
Public Function Wiz04cvtStatisticToInt(xStatistics As Long, WhichStat As Integer) As Integer
    Select Case WhichStat
        Case 1  'Strength
            Wiz04cvtStatisticToInt = ((xStatistics \ (2 ^ 0)) And &H1F)
        Case 2  'Intelligence
            Wiz04cvtStatisticToInt = ((xStatistics \ (2 ^ 5)) And &H1F)
        Case 3  'Piety
            Wiz04cvtStatisticToInt = ((xStatistics \ (2 ^ 10)) And &H1F)
        Case 4  'Vitality
            Wiz04cvtStatisticToInt = ((xStatistics \ (2 ^ 16)) And &H1F)
        Case 5  'Agility
            Wiz04cvtStatisticToInt = ((xStatistics \ (2 ^ 21)) And &H1F)
        Case 6  'Luck
            Wiz04cvtStatisticToInt = ((xStatistics \ (2 ^ 26)) And &H1F)
        Case Else
            Wiz04cvtStatisticToInt = 0
    End Select
End Function
Public Function Wiz04GetSpell(i As Integer) As String
    Wiz04GetSpell = Spells(i)
End Function
Public Sub Wiz04InitializeItemList()
...
End Sub
Public Sub Wiz04InitializeSpells()
    'Mage Spell Book...
    Spells(0) = "Unknown"
    Spells(1) = "Halito"
    Spells(2) = "Mogref"
    ...
    Spells(50) = "Kadorto"
End Sub
Public Function Wiz04IsBishop(x As Integer) As Boolean
    Wiz04IsBishop = (strProfession(x) = "Bishop")
End Function
Public Function Wiz04IsMage(x As Integer) As Boolean
    ...
    End Select
End Function
Public Function Wiz04IsPriest(x As Integer) As Boolean
    Select Case strProfession(x)
    ...
    End Select
End Function
Public Function Wiz04IsLord(x As Integer) As Boolean
    Wiz04IsLord = (strProfession(x) = "Lord")
End Function
Public Function Wiz04IsSamurai(x As Integer) As Boolean
    Wiz04IsSamurai = (strProfession(x) = "Samurai")
End Function
Public Function Wiz04IsSpellCaster(x As Integer) As Boolean
    Select Case strProfession(x)
        Case "Mage", "Priest", "Bishop", "Lord", "Samurai"
            Wiz04IsSpellCaster = True
        Case Else
            Wiz04IsSpellCaster = False
    End Select
End Function
Public Function Wiz04lkupItemByCbo(x As Integer, cbo As ComboBox) As Integer
    Dim i As Integer
    For i = 0 To cbo.ListCount - 1
        If ItemList(x) = cbo.List(i) Then
            Wiz04lkupItemByCbo = i
            Exit Function
        End If
    Next i
End Function
Public Function Wiz04lkupItemByName(x As String) As Integer
    Dim i As Integer
    For i = Wiz04ItemMapMin To Wiz04ItemMapMax
        If ItemList(i) = x Then
            Wiz04lkupItemByName = i
            Exit Function
        End If
    Next i
End Function
Public Sub Wiz04PopulateAlignment(x As ComboBox)
    Dim i As Byte
    With x
        .Clear
        For i = 0 To Wiz04AlignmentMapMax
            .AddItem strAlignment(i), CInt(i)
        Next i
    End With
End Sub
Public Sub Wiz04PopulateItem(x As ComboBox)
    Dim i As Integer
    With x
        .Clear
        For i = Wiz04ItemMapMin To Wiz04ItemMapMax
    ...
    End With
End Sub
Public Sub Wiz04PopulateProfession(x As ComboBox)
    Dim i As Byte
    With x
        .Clear
        For i = 0 To Wiz04ProfessionMapMax
            .AddItem strProfession(i), CInt(i)
        Next i
    End With
End Sub
Public Sub Wiz04PopulateRace(x As ComboBox)
    Dim i As Byte
    With x
        .Clear
        For i = 0 To Wiz04RaceMapMax
            .AddItem strRace(i), CInt(i)
        Next i
    End With
End Sub
Public Sub Wiz04PopulateSpellBooks(lstMageSpells As ListBox, lstPriestSpells As ListBox)
    Dim i As Integer
    With lstMageSpells
        .Clear
        For i = 1 To 21
    ...
    End With
End Sub
Public Sub Wiz04PopulateStatus(x As ComboBox)
    Dim i As Byte
    With x
        .Clear
        For i = 0 To Wiz04StatusMapMax
            .AddItem strStatus(i), CInt(i)
        Next i
    End With
End Sub
Public Sub Wiz04PrintCharacter(oUnit As Integer, xCharacter As Wiz04Character)
    Dim i As Long
    Dim j As Long
    Dim k As Long
    Dim iChar As Long
    ...
    With xCharacter
        ...
        Else
            Print #oUnit, "Location:           " & vbTab & Wiz04Dumapic(xCharacter)
        End If
        ...
        Print #oUnit, "Strength:           " & vbTab & Wiz04cvtStatisticToInt(.Statistics, 1)
        Print #oUnit, "Intellegence:       " & vbTab & Wiz04cvtStatisticToInt(.Statistics, 2)
        Print #oUnit, "Piety:              " & vbTab & Wiz04cvtStatisticToInt(.Statistics, 3)
        Print #oUnit, "Vitality:           " & vbTab & Wiz04cvtStatisticToInt(.Statistics, 4)
        Print #oUnit, "Agility:            " & vbTab & Wiz04cvtStatisticToInt(.Statistics, 5)
        Print #oUnit, "Luck:               " & vbTab & Wiz04cvtStatisticToInt(.Statistics, 6)
        ...
        bString = Wiz04cvtSpellsToBstr(.SpellBooks)
        
        Print #oUnit, "Mage:               " & vbTab & "Priest:"
        i = i
        Do While i <= Wiz04SpellMapMax
            If i + 21 > Wiz04SpellMapMax Then Exit Do
            MageSpell = String(20, " ")
            PriestSpell = String(20, " ")
            If i <= 21 Then
                If Mid(bString, i + 1, 1) = "1" Then
                    MageSpell = "[X] " & Wiz04GetSpell(CInt(i))
                Else
                    MageSpell = "[ ] " & Wiz04GetSpell(CInt(i))
                End If
            End If
            If Mid(bString, i + 1 + 21, 1) = "1" Then
                PriestSpell = "[X] " & Wiz04GetSpell(CInt(i + 21))
            Else
                PriestSpell = "[ ] " & Wiz04GetSpell(CInt(i + 21))
            End If
...
ErrorHandler:
    MsgBox Err.Description, vbExclamation, "Wiz04PrintCharacter"
    Exit Sub
    Resume Next
End Sub
Public Sub Wiz04Read(ByVal strFile As String, xCharacters() As Wiz04Character)
    Dim i As Long
    Dim iChar As Integer
    Dim Offset As Long
    Dim Unit As Integer
    Dim errorCode As Long
    Dim ScenarioName As Wiz04ScenarioTag
    ...
    Offset = Wiz04CharacterDataOffset
    For i = 1 To 5
        iChar = (i * 4) - 3
...
ErrorHandler:
    MsgBox Err.Description, vbExclamation, "Wiz04Read"
    Exit Sub
    Resume Next
End Sub
Public Function Wiz04ValidateScenario(xFileName As String) As Boolean
    Dim i As Long
    Dim iChar As Integer
    Dim Offset As Long
    Dim Unit As Integer
    ...
    Wiz04ValidateScenario = False
    On Error GoTo ErrorHandler
    Unit = FreeFile
    Open xFileName For Binary Access Read Lock Read As #Unit
    Get #Unit, Wiz04ScenarioDataOffset, ScenarioName
    If Left(ScenarioName.Name, ScenarioName.Length) <> Wiz04ScenarioName Then
...
ErrorHandler:
    Call MsgBox(Err.Description, vbExclamation, "Wiz04ValidateScenario")
    Exit Function
    Resume Next
End Function
Public Sub Wiz04Write(ByVal strFile As String, xCharacters() As Wiz04Character)
    Dim i As Long
    Dim iChar As Integer
    Dim Offset As Long
    Dim Unit As Integer
...
ErrorHandler:
    MsgBox Err.Description, vbExclamation, "Wiz04Write"
    Exit Sub
    Resume Next
End Sub
