...
Public Sub Wiz03InitializeItemList()
    ItemList(1000) = "Broken Item"
    ItemList(1001) = "Orb or Earithin"
    ItemList(1002) = "Neutral Crystal"
    ItemList(1003) = "Crystal of Evil"
    ItemList(1004) = "Crystal of Good"
    ItemList(1005) = "Ship in a Bottle"
    ItemList(1006) = "Staff of Earch"
    ItemList(1007) = "Amulet of Air"
    ItemList(1008) = "Holy Water"
    ItemList(1009) = "Rod of Fire"
    ItemList(1010) = "Gold Medallion"
    ItemList(1011) = "Orb of Mhuuzfis"
    ItemList(1012) = "Butterfly Knife"
    ItemList(1013) = "Short Sword"
    ItemList(1014) = "Broad Sword"
    ItemList(1015) = "Mace"
    ItemList(1016) = "Staff of Earch"
    ItemList(1017) = "Hand Axe"
    ItemList(1018) = "Battle Axe"
    ItemList(1019) = "Dagger"
    ItemList(1020) = "Flail"
    ItemList(1021) = "Round Shield"
    ItemList(1022) = "Heater Shield"
    ItemList(1023) = "Heater +2"
    ItemList(1024) = "Cuirass +2"
    ItemList(1025) = "Dailki Amulet"
    ItemList(1026) = "Mithril Gloves"
    ItemList(1027) = "Mace +2"
    ItemList(1028) = "Amber Dagger"
    ItemList(1029) = "Ebony Dagger"
    ItemList(1030) = "Ivory Dagger"
    ItemList(1031) = "Battle Axe +2"
    ItemList(1032) = "Broad Sword +2"
    ItemList(1033) = "Short Sword +2"
    ItemList(1034) = "Serpent's Tooth"
    ItemList(1035) = "Salamander Ring"
    ItemList(1036) = "Gold Ring"
    ItemList(1037) = "Sopic Philtre"
    ItemList(1038) = "Sallet -1"
    ItemList(1039) = "Plate Armor -1"
    ItemList(1040) = "Breast Plate -1"
    ItemList(1041) = "Hauberk -1"
    ItemList(1042) = "Cuirass -1"
    ItemList(1043) = "Round Shield -1"
    ItemList(1044) = "Flametongue"
    ItemList(1045) = "Wizard's Staff"
    ItemList(1046) = "Bag of Gems"
    ItemList(1047) = "Mage's Robes"
    ItemList(1048) = "?????"
    ItemList(1049) = "Hauberk"
    ItemList(1050) = "Breast Plate"
    ItemList(1051) = "Plate Armor"
    ItemList(1052) = "Sallet"
    ItemList(1053) = "Potion of Dios"
    ItemList(1054) = "Latumofis Oil"
    ItemList(1055) = "Short Sword +1"
    ItemList(1056) = "Broad Sword +1"
    ItemList(1057) = "Mace +1"
    ItemList(1058) = "Battle Axe +1"
    ItemList(1059) = "Nunchuka"
    ItemList(1060) = "Dagger +1"
    ItemList(1061) = "Katino Scroll"
    ItemList(1062) = "Cuirass +1"
    ItemList(1063) = "Hauberk +1"
    ItemList(1064) = "Breast Plate +1"
    ItemList(1065) = "Plate Armor +1"
    ItemList(1066) = "Heater +1"
    ItemList(1067) = "Bascinet"
    ItemList(1068) = "Iron Gloves"
    ItemList(1069) = "Badios Scroll"
    ItemList(1070) = "Halito Potion"
    ItemList(1071) = "Short Sword -1"
    ItemList(1072) = "Battle Axe -1"
    ItemList(1073) = "Mace -1"
    ItemList(1074) = "Dagger -1"
    ItemList(1075) = "Battle Axe -1"
    ItemList(1076) = "Margauz's Flail"
    ItemList(1077) = "Displacer Robes"
    ItemList(1078) = "Hauberk +2"
    ItemList(1079) = "Breast Plate +2"
    ItemList(1080) = "Plate Armor +2"
    ItemList(1081) = "Armet"
    ItemList(1082) = "Wargan Robes"
    ItemList(1083) = "Giant's Club"
    ItemList(1084) = "Blade Cuisinart"
    ItemList(1085) = "Shepherd Crook"
    ItemList(1086) = "Unholy Axe"
    ItemList(1087) = "Rod of Death"
    ItemList(1088) = "Gem of Exorcism"
    ItemList(1089) = "Bag of Emeralds"
    ItemList(1090) = "Bag of Garnets"
    ItemList(1091) = "Blue Pearl"
    ItemList(1092) = "Ruby Slippers"
    ItemList(1093) = "Necrology Rod"
    ItemList(1094) = "Book of Life"
    ItemList(1095) = "Book of Death"
    ItemList(1096) = "Dragon's Tooth"
    ItemList(1097) = "Trollkin Ring"
    ItemList(1098) = "Rabbit's Foot"
    ItemList(1099) = "Thief's Pick"
    ItemList(1100) = "Book of Demons"
    ItemList(1101) = "Butterfly Knife"
    ItemList(1102) = "Gold Tiara"
    ItemList(1103) = "Mantis Gloves"
End Sub
