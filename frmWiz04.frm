...
Begin VB.Form frmWiz04 
   BackColor       =   &H00000000&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Wizardry 04 - The Return of Werdna"
   ClientHeight    =   6420
   ClientLeft      =   36
   ClientTop       =   492
   ClientWidth     =   9288
   Icon            =   "frmWiz04.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6420
   ...
   Begin VB.PictureBox picFrames 
      ...
      Begin VB.ComboBox cboAlignment 
         ...
         ForeColor       =   &H0000FFFF&
         Height          =   336
         ItemData        =   "frmWiz04.frx":0316
         Left            =   4980
         List            =   "frmWiz04.frx":0320
      ...
      Begin VB.ComboBox cboRace 
         ...
         ForeColor       =   &H0000FFFF&
         Height          =   336
         ItemData        =   "frmWiz04.frx":0362
         Left            =   4980
         List            =   "frmWiz04.frx":0369
         Style           =   2  'Dropdown List
         TabIndex        =   8
      ...
      Begin VB.ComboBox cboGender 
         ...
         ForeColor       =   &H0000FFFF&
         Height          =   336
         ItemData        =   "frmWiz04.frx":0383
         Left            =   4980
         List            =   "frmWiz04.frx":038D
         Locked          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   14
         Tag             =   "TabStop"
   ...
   Begin VB.PictureBox picFrames 
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   1
         ItemData        =   "frmWiz04.frx":03A2
         Left            =   2520
         List            =   "frmWiz04.frx":03A4
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   30
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   8
         ItemData        =   "frmWiz04.frx":03A6
         Left            =   2520
         List            =   "frmWiz04.frx":03A8
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   58
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   7
         ItemData        =   "frmWiz04.frx":03AA
         Left            =   2520
         List            =   "frmWiz04.frx":03AC
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   54
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   6
         ItemData        =   "frmWiz04.frx":03AE
         Left            =   2520
         List            =   "frmWiz04.frx":03B0
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   50
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   5
         ItemData        =   "frmWiz04.frx":03B2
         Left            =   2520
         List            =   "frmWiz04.frx":03B4
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   46
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   4
         ItemData        =   "frmWiz04.frx":03B6
         Left            =   2520
         List            =   "frmWiz04.frx":03B8
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   42
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   3
         ItemData        =   "frmWiz04.frx":03BA
         Left            =   2520
         List            =   "frmWiz04.frx":03BC
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   38
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   2
         ItemData        =   "frmWiz04.frx":03BE
         Left            =   2520
         List            =   "frmWiz04.frx":03C0
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   34
         Tag             =   "TabStop"
...
Private Characters(1 To Wiz04CharactersMax) As Wiz04Character
Private SaveCharacter As Wiz04Character
...
Private Sub cmdSave_Click()
    ...
    'Call DumpWiz04(Characters(SelectedCharacter))
    Call UnloadCharacter(SelectedCharacter)
    'Debug.Print String(80, "=") & vbCrLf & "After:"
    'Call Wiz04DumpCharacter(Characters(SelectedCharacter))
    
    'Write Data back to DataFile...
    Call Wiz04Write(DataFile, Characters)
...
Private Sub Form_Activate()
    ...
    Call Wiz04Read(DataFile, Characters)
    For i = 1 To Wiz04CharactersMax
...
Private Sub Form_Load()
    ...
    Next i
    'picWiz04.Picture = frmMain.picWiz04.Picture
    ...
    Call Wiz04InitializeItemList
    Call Wiz04InitializeSpells
    
    Call Wiz04PopulateStatus(cboStatus)
    Call Wiz04PopulateProfession(cboProfession)
    Call Wiz04PopulateAlignment(cboAlignment)
    Call Wiz04PopulateRace(cboRace)
    For i = 1 To Wiz04ItemListMax
        Call Wiz04PopulateItem(cboItem(i))
    Next i
    Call Wiz04PopulateSpellBooks(lstMageSpells, lstPriestSpells)
End Sub
...
Private Sub LoadCharacter(iCharacter As Integer)
    ...
    With Characters(iCharacter)
        ...
        txtSTR.Text = Wiz04cvtStatisticToInt(.Statistics, 1)
        txtINT.Text = Wiz04cvtStatisticToInt(.Statistics, 2)
        txtPIE.Text = Wiz04cvtStatisticToInt(.Statistics, 3)
        txtVIT.Text = Wiz04cvtStatisticToInt(.Statistics, 4)
        txtAGL.Text = Wiz04cvtStatisticToInt(.Statistics, 5)
        txtLCK.Text = Wiz04cvtStatisticToInt(.Statistics, 6)
        ...
        For i = 1 To .ItemCount
            cboItem(i).ListIndex = Wiz04lkupItemByCbo(.ItemList(i).ItemCode, cboItem(i))
...
Private Sub mnuOptionsPrint_Click()
    ...
    For i = 1 To UBound(Characters)
        If Trim(Characters(i).Name) <> vbNullString Then Call Wiz04PrintCharacter(oUnit, Characters(i))
    Next i
    Close #oUnit
...
Private Sub ResetSpellPointMax()
    ...
    If Wiz04IsSamurai(cClass) Then  '?
        ...
        udMage6.Max = 4
        udMage7.Max = 3
    ElseIf Wiz04IsLord(cClass) Then  'Usually, you get to be a Lord after being a Bishop, so I'll give you Mage points too...!
        udMage1.Max = 4
        udMage2.Max = 2
        udMage3.Max = 2
        udMage4.Max = 3
...
Private Sub UnloadCharacter(iCharacter As Integer)
    ...
    With Characters(iCharacter)
        ...
        .Statistics = Wiz04cvtStatisticsToLong(txtSTR.Text, txtINT.Text, txtPIE.Text, txtVIT.Text, txtAGL.Text, txtLCK.Text)
        ...
        For i = 1 To Wiz04SpellMapMax
            ...
            End If
        Next i
        Call Wiz04cvtBstrToSpells(bString, .SpellBooks)
        ...
        .ItemCount = 0
        For i = 1 To Wiz04ItemListMax
            .ItemList(i).ItemCode = Wiz04lkupItemByName(cboItem(i).Text)
