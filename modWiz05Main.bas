...
Global Const Wiz05ScenarioName As String = "HEART OF THE MAELSTROM"
Global Const Wiz05ScenarioDataOffset As Long = &H25801
Global Const Wiz05CharacterDataOffset As Long = &H25C01
Global Const Wiz05CharactersMax As Integer = 20
Global Const Wiz05ItemListMax As Integer = 8
Global Const Wiz05ItemMapMin As Integer = 1000
Global Const Wiz05ItemMapMax As Integer = 1103
Global Const Wiz05AlignmentMapMax As Integer = 3
Global Const Wiz05RaceMapMax As Integer = 5
Global Const Wiz05ProfessionMapMax As Integer = 7
Global Const Wiz05StatusMapMax As Integer = 7
Global Const Wiz05SpellLevelMax As Integer = 7
Global Const Wiz05SpellMapMax As Integer = 50

Type Wiz05ScenarioTag
    Length As Byte
    Name As String * 48
End Type
...
Type Wiz05Character
    ...
    ItemList(1 To 8) As Wiz05Item       '0x1D83C    List of Items (stowing not an option in Wiz05...)
    EXP(1 To 3) As Integer              '0x1D87C
    LVL As Wiz05Points                  '0x1D882
    HP As Wiz05Points                   '0x1D886
...
End Type
Private ItemList(Wiz05ItemMapMin To Wiz05ItemMapMax) As String
Private Spells(0 To Wiz05SpellMapMax) As String
...
Private Function strRace(ByVal x As Byte) As String
    ...
    End Select
End Function
Private Function strItem(x As Wiz05Item) As String
...
End Function
Private Function strPoints(x As Wiz05Points) As String
...
End Function
Private Function Wiz05Dumapic(xCharacter As Wiz05Character) As String
    With xCharacter
        ' Always seems to be facing North when Quiting from within the Maze...
        Wiz05Dumapic = "Facing North; " & (.Location \ 100) & " East; " & (.Location Mod 100) & " North; " & .Down & " Down"  ' from the steps leading to the castle"
    End With
End Function
Public Sub Wiz05DumpCharacter(xCharacter As Wiz05Character)
    Dim i As Long
    Dim j As Long
    Dim k As Long
    Dim iChar As Long
    ...
    With xCharacter
        ...
        End If
        Debug.Print Wiz05Dumapic(xCharacter)
        ...
        Debug.Print "Strength:           " & vbTab & Wiz05cvtStatisticToInt(.Statistics, 1)
        Debug.Print "Intellegence:       " & vbTab & Wiz05cvtStatisticToInt(.Statistics, 2)
        Debug.Print "Piety:              " & vbTab & Wiz05cvtStatisticToInt(.Statistics, 3)
        Debug.Print "Vitality:           " & vbTab & Wiz05cvtStatisticToInt(.Statistics, 4)
        Debug.Print "Agility:            " & vbTab & Wiz05cvtStatisticToInt(.Statistics, 5)
        Debug.Print "Luck:               " & vbTab & Wiz05cvtStatisticToInt(.Statistics, 6)
...
ErrorHandler:
    MsgBox Err.Description, vbExclamation, "Wiz05DumpCharacter"
    Exit Sub
    Resume Next
End Sub
Public Sub Wiz05cvtBstrToSpells(bString As String, Data() As Byte)
    Dim i As Long
...
ErrorHandler:
    MsgBox Err.Description, vbExclamation, "Wiz05cvtSpellsToBstr"
    Exit Sub
    Resume Next
End Sub
Public Function Wiz05cvtSpellsToBstr(Data() As Byte) As String
    Dim i As Long
...
ErrorHandler:
    ...
    Resume Next
End Function
Public Function Wiz05cvtStatisticsToLong(Stat1 As String, Stat2 As String, Stat3 As String, Stat4 As String, Stat5 As String, Stat6 As String) As Long
    Wiz05cvtStatisticsToLong = (CLng(Stat1) * (2 ^ 0)) + (CLng(Stat2) * (2 ^ 5)) + (CLng(Stat3) * (2 ^ 10)) + (CLng(Stat4) * (2 ^ 16)) + (CLng(Stat5) * (2 ^ 21)) + (CLng(Stat6) * (2 ^ 26))
End Function
Public Function Wiz05cvtStatisticToInt(xStatistics As Long, WhichStat As Integer) As Integer
    Select Case WhichStat
        Case 1  'Strength
            Wiz05cvtStatisticToInt = ((xStatistics \ (2 ^ 0)) And &H1F)
        Case 2  'Intelligence
            Wiz05cvtStatisticToInt = ((xStatistics \ (2 ^ 5)) And &H1F)
        Case 3  'Piety
            Wiz05cvtStatisticToInt = ((xStatistics \ (2 ^ 10)) And &H1F)
        Case 4  'Vitality
            Wiz05cvtStatisticToInt = ((xStatistics \ (2 ^ 16)) And &H1F)
        Case 5  'Agility
            Wiz05cvtStatisticToInt = ((xStatistics \ (2 ^ 21)) And &H1F)
        Case 6  'Luck
            Wiz05cvtStatisticToInt = ((xStatistics \ (2 ^ 26)) And &H1F)
        Case Else
            Wiz05cvtStatisticToInt = 0
    End Select
End Function
Public Function Wiz05GetSpell(i As Integer) As String
    Wiz05GetSpell = Spells(i)
End Function
Public Sub Wiz05InitializeItemList()
...
End Sub
Public Sub Wiz05InitializeSpells()
    'Mage Spell Book...
    Spells(0) = "Unknown"
    Spells(1) = "Halito"
    Spells(2) = "Mogref"
    ...
    Spells(50) = "Kadorto"
End Sub
Public Function Wiz05IsBishop(x As Integer) As Boolean
    Wiz05IsBishop = (strProfession(x) = "Bishop")
End Function
Public Function Wiz05IsMage(x As Integer) As Boolean
    ...
    End Select
End Function
Public Function Wiz05IsPriest(x As Integer) As Boolean
    Select Case strProfession(x)
    ...
    End Select
End Function
Public Function Wiz05IsLord(x As Integer) As Boolean
    Wiz05IsLord = (strProfession(x) = "Lord")
End Function
Public Function Wiz05IsSamurai(x As Integer) As Boolean
    Wiz05IsSamurai = (strProfession(x) = "Samurai")
End Function
Public Function Wiz05IsSpellCaster(x As Integer) As Boolean
    Select Case strProfession(x)
        Case "Mage", "Priest", "Bishop", "Lord", "Samurai"
            Wiz05IsSpellCaster = True
        Case Else
            Wiz05IsSpellCaster = False
    End Select
End Function
Public Function Wiz05lkupItemByCbo(x As Integer, cbo As ComboBox) As Integer
    Dim i As Integer
    For i = 0 To cbo.ListCount - 1
        If ItemList(x) = cbo.List(i) Then
            Wiz05lkupItemByCbo = i
            Exit Function
        End If
    Next i
End Function
Public Function Wiz05lkupItemByName(x As String) As Integer
    Dim i As Integer
    For i = Wiz05ItemMapMin To Wiz05ItemMapMax
        If ItemList(i) = x Then
            Wiz05lkupItemByName = i
            Exit Function
        End If
    Next i
End Function
Public Sub Wiz05PopulateAlignment(x As ComboBox)
    Dim i As Byte
    With x
        .Clear
        For i = 0 To Wiz05AlignmentMapMax
            .AddItem strAlignment(i), CInt(i)
        Next i
    End With
End Sub
Public Sub Wiz05PopulateItem(x As ComboBox)
    Dim i As Integer
    With x
        .Clear
        For i = Wiz05ItemMapMin To Wiz05ItemMapMax
    ...
    End With
End Sub
Public Sub Wiz05PopulateProfession(x As ComboBox)
    Dim i As Byte
    With x
        .Clear
        For i = 0 To Wiz05ProfessionMapMax
            .AddItem strProfession(i), CInt(i)
        Next i
    End With
End Sub
Public Sub Wiz05PopulateRace(x As ComboBox)
    Dim i As Byte
    With x
        .Clear
        For i = 0 To Wiz05RaceMapMax
            .AddItem strRace(i), CInt(i)
        Next i
    End With
End Sub
Public Sub Wiz05PopulateSpellBooks(lstMageSpells As ListBox, lstPriestSpells As ListBox)
    Dim i As Integer
    With lstMageSpells
        .Clear
        For i = 1 To 21
    ...
    End With
End Sub
Public Sub Wiz05PopulateStatus(x As ComboBox)
    Dim i As Byte
    With x
        .Clear
        For i = 0 To Wiz05StatusMapMax
            .AddItem strStatus(i), CInt(i)
        Next i
    End With
End Sub
Public Sub Wiz05PrintCharacter(oUnit As Integer, xCharacter As Wiz05Character)
    Dim i As Long
    Dim j As Long
    Dim k As Long
    Dim iChar As Long
    ...
    With xCharacter
        ...
        Else
            Print #oUnit, "Location:           " & vbTab & Wiz05Dumapic(xCharacter)
        End If
        ...
        Print #oUnit, "Strength:           " & vbTab & Wiz05cvtStatisticToInt(.Statistics, 1)
        Print #oUnit, "Intellegence:       " & vbTab & Wiz05cvtStatisticToInt(.Statistics, 2)
        Print #oUnit, "Piety:              " & vbTab & Wiz05cvtStatisticToInt(.Statistics, 3)
        Print #oUnit, "Vitality:           " & vbTab & Wiz05cvtStatisticToInt(.Statistics, 4)
        Print #oUnit, "Agility:            " & vbTab & Wiz05cvtStatisticToInt(.Statistics, 5)
        Print #oUnit, "Luck:               " & vbTab & Wiz05cvtStatisticToInt(.Statistics, 6)
        ...
        bString = Wiz05cvtSpellsToBstr(.SpellBooks)
        
        Print #oUnit, "Mage:               " & vbTab & "Priest:"
        i = i
        Do While i <= Wiz05SpellMapMax
            If i + 21 > Wiz05SpellMapMax Then Exit Do
            MageSpell = String(20, " ")
            PriestSpell = String(20, " ")
            If i <= 21 Then
                If Mid(bString, i + 1, 1) = "1" Then
                    MageSpell = "[X] " & Wiz05GetSpell(CInt(i))
                Else
                    MageSpell = "[ ] " & Wiz05GetSpell(CInt(i))
                End If
            End If
            If Mid(bString, i + 1 + 21, 1) = "1" Then
                PriestSpell = "[X] " & Wiz05GetSpell(CInt(i + 21))
            Else
                PriestSpell = "[ ] " & Wiz05GetSpell(CInt(i + 21))
            End If
...
ErrorHandler:
    MsgBox Err.Description, vbExclamation, "Wiz05PrintCharacter"
    Exit Sub
    Resume Next
End Sub
Public Sub Wiz05Read(ByVal strFile As String, xCharacters() As Wiz05Character)
    Dim i As Long
    Dim iChar As Integer
    Dim Offset As Long
    Dim Unit As Integer
    Dim errorCode As Long
    Dim ScenarioName As Wiz05ScenarioTag
    ...
    Offset = Wiz05CharacterDataOffset
    For i = 1 To 5
        iChar = (i * 4) - 3
...
ErrorHandler:
    MsgBox Err.Description, vbExclamation, "Wiz05Read"
    Exit Sub
    Resume Next
End Sub
Public Function Wiz05ValidateScenario(xFileName As String) As Boolean
    Dim i As Long
    Dim iChar As Integer
    Dim Offset As Long
    Dim Unit As Integer
    ...
    Wiz05ValidateScenario = False
    On Error GoTo ErrorHandler
    Unit = FreeFile
    Open xFileName For Binary Access Read Lock Read As #Unit
    Get #Unit, Wiz05ScenarioDataOffset, ScenarioName
    If Left(ScenarioName.Name, ScenarioName.Length) <> Wiz05ScenarioName Then
...
ErrorHandler:
    Call MsgBox(Err.Description, vbExclamation, "Wiz05ValidateScenario")
    Exit Function
    Resume Next
End Function
Public Sub Wiz05Write(ByVal strFile As String, xCharacters() As Wiz05Character)
    Dim i As Long
    Dim iChar As Integer
    Dim Offset As Long
    Dim Unit As Integer
...
ErrorHandler:
    MsgBox Err.Description, vbExclamation, "Wiz05Write"
    Exit Sub
    Resume Next
End Sub
