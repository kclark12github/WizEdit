...
Begin VB.Form frmWiz05 
   BackColor       =   &H00000000&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Wizardry 05 - Heart of the Maelstrom"
   ClientHeight    =   6420
   ClientLeft      =   36
   ClientTop       =   492
   ClientWidth     =   9288
   Icon            =   "frmWiz05.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6420
   ...
   Begin VB.PictureBox picFrames 
      ...
      Begin VB.ComboBox cboAlignment 
         ...
         ForeColor       =   &H0000FFFF&
         Height          =   336
         ItemData        =   "frmWiz05.frx":1CD6
         Left            =   4980
         List            =   "frmWiz05.frx":1CE0
      ...
      Begin VB.ComboBox cboRace 
         ...
         ForeColor       =   &H0000FFFF&
         Height          =   336
         ItemData        =   "frmWiz05.frx":1D22
         Left            =   4980
         List            =   "frmWiz05.frx":1D29
         Style           =   2  'Dropdown List
         TabIndex        =   8
      ...
      Begin VB.ComboBox cboGender 
         ...
         ForeColor       =   &H0000FFFF&
         Height          =   336
         ItemData        =   "frmWiz05.frx":1D43
         Left            =   4980
         List            =   "frmWiz05.frx":1D4D
         Locked          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   14
         Tag             =   "TabStop"
   ...
   Begin VB.PictureBox picFrames 
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   1
         ItemData        =   "frmWiz05.frx":1D62
         Left            =   2520
         List            =   "frmWiz05.frx":1D64
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   30
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   8
         ItemData        =   "frmWiz05.frx":1D66
         Left            =   2520
         List            =   "frmWiz05.frx":1D68
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   58
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   7
         ItemData        =   "frmWiz05.frx":1D6A
         Left            =   2520
         List            =   "frmWiz05.frx":1D6C
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   54
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   6
         ItemData        =   "frmWiz05.frx":1D6E
         Left            =   2520
         List            =   "frmWiz05.frx":1D70
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   50
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   5
         ItemData        =   "frmWiz05.frx":1D72
         Left            =   2520
         List            =   "frmWiz05.frx":1D74
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   46
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   4
         ItemData        =   "frmWiz05.frx":1D76
         Left            =   2520
         List            =   "frmWiz05.frx":1D78
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   42
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   3
         ItemData        =   "frmWiz05.frx":1D7A
         Left            =   2520
         List            =   "frmWiz05.frx":1D7C
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   38
         Tag             =   "TabStop"
      ...
      Begin VB.ComboBox cboItem 
         ...
         Height          =   336
         Index           =   2
         ItemData        =   "frmWiz05.frx":1D7E
         Left            =   2520
         List            =   "frmWiz05.frx":1D80
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   34
         Tag             =   "TabStop"
...
Private Characters(1 To Wiz05CharactersMax) As Wiz05Character
Private SaveCharacter As Wiz05Character
...
Private Sub cmdSave_Click()
    ...
    'Call DumpWiz05(Characters(SelectedCharacter))
    Call UnloadCharacter(SelectedCharacter)
    'Debug.Print String(80, "=") & vbCrLf & "After:"
    'Call Wiz05DumpCharacter(Characters(SelectedCharacter))
    
    'Write Data back to DataFile...
    Call Wiz05Write(DataFile, Characters)
...
Private Sub Form_Activate()
    ...
    Call Wiz05Read(DataFile, Characters)
    For i = 1 To Wiz05CharactersMax
...
Private Sub Form_Load()
    ...
    Next i
    'picWiz05.Picture = frmMain.picWiz05.Picture
    ...
    Call Wiz05InitializeItemList
    Call Wiz05InitializeSpells
    
    Call Wiz05PopulateStatus(cboStatus)
    Call Wiz05PopulateProfession(cboProfession)
    Call Wiz05PopulateAlignment(cboAlignment)
    Call Wiz05PopulateRace(cboRace)
    For i = 1 To Wiz05ItemListMax
        Call Wiz05PopulateItem(cboItem(i))
    Next i
    Call Wiz05PopulateSpellBooks(lstMageSpells, lstPriestSpells)
End Sub
...
Private Sub LoadCharacter(iCharacter As Integer)
    ...
    With Characters(iCharacter)
        ...
        txtSTR.Text = Wiz05cvtStatisticToInt(.Statistics, 1)
        txtINT.Text = Wiz05cvtStatisticToInt(.Statistics, 2)
        txtPIE.Text = Wiz05cvtStatisticToInt(.Statistics, 3)
        txtVIT.Text = Wiz05cvtStatisticToInt(.Statistics, 4)
        txtAGL.Text = Wiz05cvtStatisticToInt(.Statistics, 5)
        txtLCK.Text = Wiz05cvtStatisticToInt(.Statistics, 6)
        ...
        For i = 1 To .ItemCount
            cboItem(i).ListIndex = Wiz05lkupItemByCbo(.ItemList(i).ItemCode, cboItem(i))
...
Private Sub mnuOptionsPrint_Click()
    ...
    For i = 1 To UBound(Characters)
        If Trim(Characters(i).Name) <> vbNullString Then Call Wiz05PrintCharacter(oUnit, Characters(i))
    Next i
    Close #oUnit
...
Private Sub ResetSpellPointMax()
    ...
    If Wiz05IsSamurai(cClass) Then  '?
        ...
        udMage6.Max = 4
        udMage7.Max = 3
    ElseIf Wiz05IsLord(cClass) Then  'Usually, you get to be a Lord after being a Bishop, so I'll give you Mage points too...!
        udMage1.Max = 4
        udMage2.Max = 2
        udMage3.Max = 2
        udMage4.Max = 3
...
Private Sub UnloadCharacter(iCharacter As Integer)
    ...
    With Characters(iCharacter)
        ...
        .Statistics = Wiz05cvtStatisticsToLong(txtSTR.Text, txtINT.Text, txtPIE.Text, txtVIT.Text, txtAGL.Text, txtLCK.Text)
        ...
        For i = 1 To Wiz05SpellMapMax
            ...
            End If
        Next i
        Call Wiz05cvtBstrToSpells(bString, .SpellBooks)
        ...
        .ItemCount = 0
        For i = 1 To Wiz05ItemListMax
            .ItemList(i).ItemCode = Wiz05lkupItemByName(cboItem(i).Text)
